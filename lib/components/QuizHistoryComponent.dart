...
class QuizHistoryComponentState extends State<QuizHistoryComponent> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          widget.quizHistoryData!.quizType != QuizTypeSelfChallenge
              ? Image.asset(widget.quizHistoryData!.image!,
          ...
          Column(
            ...
            children: [
              ...
              8.height,
              Text(
                  'Score: ${widget.quizHistoryData!.rightQuestion}/${widget.quizHistoryData!.totalQuestion}',
                  style: boldTextStyle()),
              8.height,
              Text(
                  '${DateFormat('dd MMM yyyy kk:mm').format(DateTime.fromMicrosecondsSinceEpoch(widget.quizHistoryData!.createdAt!.microsecondsSinceEpoch))}',

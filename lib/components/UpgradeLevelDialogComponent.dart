...
class UpgradeLevelDialogComponent extends StatefulWidget {
  ...
  @override
  UpgradeLevelDialogComponentState createState() =>
      UpgradeLevelDialogComponentState();
}

class UpgradeLevelDialogComponentState
    extends State<UpgradeLevelDialogComponent> {
  @override
  void initState() {
    super.initState();
    init();

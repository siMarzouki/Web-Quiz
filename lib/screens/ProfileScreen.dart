...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  Future update() async {
    if (formKey.currentState!.validate()) {
      ...
      if (image != null) {
        await uploadFile(file: File(image!.path), prefix: 'userProfiles')
            .then((path) async {
      ...
      await userDBService
          .updateDocument(req, appStore.userId)
          .then((value) async {
                ...
                children: [
                  ...
                  Observer(
                      builder: (context) => Text(appStore.userName!,
                          ...
                          .center()),
                  4.height,
                  Text('Points: ${getIntAsync(USER_POINTS)}',

...
class QuizQuestionsScreenState extends State<QuizQuestionsScreen> {
  ...
  void onSubmit() {
    showConfirmDialog(context, lbl_want_to_submit, barrierDismissible: false)
        .then((value) {
      if (value ?? false) {
        submitQuiz.call();
      }
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                          'Questions: ${selectedPageIndex + 1}/${widget.quizData!.questionRef!.length}',
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          16.height,
                          if (index == 0 &&
                              widget.quizData!.questionRef!.length != 1)
                            gradientButton(
                              text: 'Next',
                              onTap: () {
                              ...
                              index < widget.quizData!.questionRef!.length - 1)
                            Row(
                              children: [
                                gradientButton(
                                  text: 'Previous',
